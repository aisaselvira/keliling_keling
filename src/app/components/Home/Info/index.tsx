                    ...
                    <div className="xl:col-span-7 lg:col-span-6 col-span-12 lg:mt-0 mt-10">
                        <form onSubmit={handleSubmit} className="grid grid-cols-2 sm:gap-2.188 gap-4 lg:ml-12">
                            <div className="sm:col-span-1 col-span-2">
                                <label htmlFor="Fname" className="text-lg font-medium inline-block text-white mb-4">
                                    Full Name
                                </label>
                                <input
                                    type="text"
                            ...
                            <div className="sm:col-span-1 col-span-2">
                                <label htmlFor="Phone" className="text-lg font-medium inline-block text-white mb-4">
                                    Phone No.
                                </label>
                                <input
                                    type="number"
                            ...
                            <div className="col-span-2">
                                <label htmlFor="Mail" className="text-lg font-medium inline-block text-white mb-4">
                                    Email
                                </label>
                                <input
                                    type="email"
                            ...
                            <div className="col-span-2">
                                <label htmlFor="password" className="text-lg font-medium inline-block text-white mb-4">
                                    Message
                                </label>
                                <textarea
                                    id="Message"
                            ...
                            <div className="col-span-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <label htmlFor="condition" className="text-lg font-medium text-white">
                                        you agree to our{" "}
                                        <Link href="#" className="text-primary hover:text-orange-600 duration-300">
