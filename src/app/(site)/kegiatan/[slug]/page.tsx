...
export default async function Post({params}: any) {
    const posts = getAllPosts(["title", "date", "excerpt", "coverImage", "slug"]);
    const post = getPostBySlug(params.slug, ["title", "author", "authorImage", "content", "coverImage", "date"]);
                ...
                <div className="container lg:max-w-xl md:max-w-screen-md  mx-auto px-4">
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                        ...
                        <div className="flex items-center md:justify-center justify-start gap-6 col-span-4 pt-4 md:pt-0">
                            ...
                            />
                            <div className="">
                                <span className="text-xl font-bold text-midnight_text dark:text-white">Baedowi</span>
            ...
            <section className="dark:bg-darkmode pt-8!">
                <div className="container lg:max-w-xl md:max-w-screen-md mx-auto px-4">
                    <div className="grid-cols-3 grid">
                        <div className="z-20 mb-24 max-h-[750px] overflow-hidden rounded col-span-3">
                            <Image
                                src={post.coverImage}
                                alt="image"
                                width={1170}
